...
public class MyHashMapDuplicate<K, V> implements MyMap<K, V> {
     ...
     * default load factor
     */
    public MyHashMapDuplicate(int initialCapacity) {
     ...
     * and load factor
     */
    public MyHashMapDuplicate(int initialCapacity, float loadFactorThreshold) {
